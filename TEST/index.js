...
var bccddresses = process.env.BccAddr;
var bccddresses_1 = process.env.BccAddr1;
...
exports.handler = (event, context, callback) => {
    ...
    function sendMail() {
        ...
        var params = {
            Destination: {
                ToAddresses: [toddresses, bccddresses, bccddresses_1]
            },
            Message: {
                Body: {
                    Html: {
                ...
                Subject: {
                    Data: "FPTEST [SES] Daily -  Notification Reports",
                    Charset: 'utf-8'
                }
            },
            Source: srcaddr,
